...
public class AutoCompleteDictionaryTrieTester {
	...
	public void testIsWord()
	{
		...
		assertEquals("Testing isWord on empty: empty string", false, emptyDict.isWord("helloee"));
		assertEquals("Testing isWord on large: hellow", false, largeDict.isWord("hel"));
